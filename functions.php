...
function square_one_scripts() {
    ...
    wp_enqueue_script( 'contact-form-validate', get_template_directory_uri() . '/js/contact-form-validate.js', array('square-one-jquery','square-one-jquery-validate'), '20120206', true );
